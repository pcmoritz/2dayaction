abalone:
	g++ -g -Wall abalone.cc print_field.cc field.cc move.cc direction.cc possible_moves.cc -o a.out
random_nick:
...
nick:
	g++ abalone.cc print_field.cc field.cc move.cc direction.cc possible_moves.cc random_ki.hh nick_ki.hh misc.hh -o a.out
pcmoritz:
